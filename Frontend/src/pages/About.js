...
const About = () => {
  return (
    <div className="h-screen bg-gradient-to-br from-blue-800 to-purple-700 flex justify-center items-center p-4 md:p-8">
    <div className="h-[70%] bg-black bg-opacity-60 rounded-lg shadow-xl p-6 md:p-12 m-4 w-full backdrop-blur-md animate-fade-in">
        <h1 className="mt-24 font-bold text-3xl md:text-4xl lg:text-5xl text-center mb-6 md:mb-8 animate-slide-in-down">
